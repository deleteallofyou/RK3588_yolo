...
int main(int argc, char** argv)
{
  ...
  inputs[0].size         = width * height * channel; // ͼ
  ...
  // printf("test4\n");
  rknn_inputs_set(ctx, io_num.n_input, inputs);//mask

  //   for(int i = 0; i < io_num.n_input; i++){
  //   printf("inputs %d buf %d\n", i, inputs[i].buf);
  //   printf("inputs %d size %d\n", i, inputs[i].size);
  //   printf("inputs %d index %d\n", i, inputs[i].index);
  //   printf("inputs %d pass_through %d\n", i, inputs[i].pass_through);
  ...
  for (int i = 0; i < io_num.n_output; i++) {
    outputs[i].want_float = 0;//设置为1？
  }
  // 
  ret = rknn_run(ctx, NULL);
  printf("test6\n");

  ret = rknn_outputs_get(ctx, io_num.n_output, outputs, NULL);// mask

  // for(int i = 0; i < io_num.n_output; i++){
  //   printf("outputs %d want_float %d\n", i, outputs[i].want_float);
  //   printf("outputs %d is_prealloc %d\n", i, outputs[i].is_prealloc);
  //   printf("outputs %d index %d\n", i, outputs[i].index);
  //   printf("outputs %d size %d\n", i, outputs[i].size);
  // }
